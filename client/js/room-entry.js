...
import './i18n.js?v=79';
import './ui-mode.js?v=79';
import './settings-panel.js?v=79';
import './socket-client.js?v=79';
import './board.js?v=79';
import './room.js?v=79';
import './chat-ui.js?v=79';
import './room-ui.js?v=79';
import './game-ui.js?v=79';
import './room-socket.js?v=79';
