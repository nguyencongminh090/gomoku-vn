...
const TRANSLATIONS = {
  vi: {
    ...
    'tmatch.series_check_in_prompt': 'Cả hai người chơi cần quay lại trang giải đấu và bấm "Sẵn sàng" để bắt đầu ván tiếp theo.',
    'tmatch.series_back_to_check_in': 'Về trang giải đấu để sẵn sàng',
  ...
  en: {
    ...
    'tmatch.series_check_in_prompt': 'Both players need to go back to the tournament page and check in as "Ready" to start the next game.',
    'tmatch.series_back_to_check_in': 'Back to tournament to check in',
