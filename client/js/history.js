...
function startAutoPlay() {
  ...
  btnPlay.innerHTML = '<svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=132#ph-bold-pause"></use></svg>';
...
function stopAutoPlay() {
  ...
  btnPlay.innerHTML = '<svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=132#ph-bold-play"></use></svg>';
