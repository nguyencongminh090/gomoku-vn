...
function renderHeader() {
  ...
  let metaHtml = `<span class="detail-meta-item"><svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=158#ph-regular-trophy"></use></svg>${t('tmatch.in_tournament')}</span>`;
  ...
  if (isSeries) {
    ...
    metaHtml += `<span class="detail-meta-item"><svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=158#ph-regular-medal"></use></svg>${gameLabel}</span>`;
    ...
    metaHtml += `<span class="detail-meta-item"><svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=158#ph-regular-flag-checkered"></use></svg>${targetLabel}</span>`;
  }
  ...
  if ((openingPhase === 'p2choice' || openingPhase === 'p1choice') && mine) {
    swap2BannerSlot.innerHTML = `
      <div class="swap2-banner">
        <svg class="icon"><use href="assets/icons/phosphor-sprite.svg?v=158#ph-regular-shuffle"></use></svg>
...
function showResultOverlay(result, seriesOverride) {
  ...
  document.getElementById('match-result-icon').querySelector('use').setAttribute('href', `assets/icons/phosphor-sprite.svg?v=158#ph-bold-${iconClass.slice(3)}`);
...
function showSeriesTransition(result) {
  ...
  document.getElementById('series-transition-icon').querySelector('use').setAttribute('href', `assets/icons/phosphor-sprite.svg?v=158#ph-bold-${iconClass.slice(3)}`);
